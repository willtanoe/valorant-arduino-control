...
"[project]/src/lib/arduino.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
 ...
 * Handles communication with Arduino device over Web Serial API
...
class ArduinoService {
   ...
   */ async connect() {
        try {
            ...
            this.port = await navigator.serial.requestPort({
                // Optional filters for specific Arduino devices
                filters: []
            });
            ...
            throw new Error('Failed to open serial port streams');
        } catch (error) {
   ...
   */ async disconnect() {
        try {
            ...
            console.error('Arduino disconnection failed:', error);
            return false;
        }
    }
    /**
   * Send movement commands to Arduino
   * @param x X-axis movement (-32768 to 32767)
   * @param y Y-axis movement (-32768 to 32767)
   */ async sendMovement(x, y) {
        if (!this.writer || !this.connectionStatus) {
            throw new Error('Arduino not connected');
        }
        try {
            // Clamp values to 16-bit range
            const clampedX = Math.max(-32768, Math.min(32767, x));
            const clampedY = Math.max(-32768, Math.min(32767, y));
            // Create movement command buffer
...
"[project]/src/lib/arduino-manager.ts [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/arduino.ts [app-client] (ecmascript)");
'use client';
;
class ArduinoManager {
    ...
    constructor(){
        if ("TURBOPACK compile-time truthy", 1) {
            // Keep connection alive even when window is closed
    ...
    async startBackgroundOperation() {
        if (this.isRunning) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].connect();
            this.isRunning = true;
            // Set up periodic check to maintain connection
            this.intervalId = setInterval(()=>{
                if (!__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].isConnected()) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].connect().catch(console.error);
                }
            }, 5000);
            // Store connection state
            localStorage.setItem('arduino-running', 'true');
        } catch (error) {
            console.error('Failed to start background operation:', error);
        }
    }
    async stopBackgroundOperation() {
        if (!this.isRunning) return;
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].disconnect();
            if (this.intervalId) {
                clearInterval(this.intervalId);
                this.intervalId = null;
            }
            this.isRunning = false;
            localStorage.removeItem('arduino-running');
        } catch (error) {
            console.error('Failed to stop background operation:', error);
        }
    }
    persistConnection() {
        if (this.isRunning) {
    ...
    // Check if the connection should be restored on page load
    async checkAndRestoreConnection() {
        const wasRunning = localStorage.getItem('arduino-running') === 'true';
        if (wasRunning) {
            await this.startBackgroundOperation();
        }
    }
}
const arduinoManager = ArduinoManager.getInstance();
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
"[project]/src/components/ArduinoControl.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/arduino-manager.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/arduino.ts [app-client] (ecmascript)");
;
...
function ArduinoControl() {
    ...
    const [hotkey, setHotkey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('F2');
    const [isHotkeyEnabled, setIsHotkeyEnabled] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [isSettingHotkey, setIsSettingHotkey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(false);
    const [sensitivity, setSensitivity] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(10);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArduinoControl.useEffect": ()=>{
            // Check if connection should be restored
            __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoManager"].checkAndRestoreConnection();
            // Set up connection status listener
            const cleanup = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].onConnectionChange({
                "ArduinoControl.useEffect.cleanup": (status)=>{
                    setIsConnected(status);
                    setError(status ? null : 'Connection lost');
                }
            }["ArduinoControl.useEffect.cleanup"]);
            return ({
                "ArduinoControl.useEffect": ()=>{
                    cleanup();
                }
    ...
    const handleConnect = async ()=>{
        try {
            ...
            setError('Please select your Arduino device from the popup...');
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoManager"].startBackgroundOperation();
            setError(null);
        } catch (err) {
            if (err.name === 'NotFoundError') {
                setError('No Arduino device was selected. Please try again and select a device.');
            } else if (err.name === 'SecurityError') {
                setError('Permission to access Arduino was denied. Please grant permission and try again.');
            } else {
                setError(`Error connecting to Arduino: ${err.message || 'Unknown error'}`);
            }
    ...
    const handleDisconnect = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2d$manager$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoManager"].stopBackgroundOperation();
            setError(null);
        } catch (err) {
            setError('Error disconnecting from Arduino');
        }
    };
    // Handle hotkey setting
    const handleSetHotkey = ()=>{
        setIsSettingHotkey(true);
        setError('Press any key to set as hotkey...');
    };
    // Handle key press for hotkey setting
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ArduinoControl.useEffect": ()=>{
            const handleKeyPress = {
                "ArduinoControl.useEffect.handleKeyPress": (event)=>{
                    if (isSettingHotkey) {
                        event.preventDefault();
                        setHotkey(event.key.toUpperCase());
                        setIsSettingHotkey(false);
                        setError(null);
                    } else if (isHotkeyEnabled && event.key.toUpperCase() === hotkey && isConnected) {
                        // Send movement command when hotkey is pressed
                        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$arduino$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["arduinoService"].sendMovement(sensitivity, sensitivity).catch({
                            "ArduinoControl.useEffect.handleKeyPress": (err)=>setError('Failed to send movement command')
                        }["ArduinoControl.useEffect.handleKeyPress"]);
                    }
                }
            }["ArduinoControl.useEffect.handleKeyPress"];
        ...
        children: [
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardHeader"], {
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardTitle"], {
                    children: "Arduino Control Panel"
                }, void 0, false, {
                    fileName: "[project]/src/components/ArduinoControl.tsx",
                    lineNumber: 99,
                    columnNumber: 9
                }, this)
            }, void 0, false, {
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                ...
                children: [
                    error && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Alert"], {
                        variant: error.includes('Please select') ? 'default' : 'destructive',
                        className: "mb-4",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Button"], {
                                ...
                                className: "w-28 transition-all duration-200 hover:scale-105",
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$switch$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Switch"], {
                                ...
                                onCheckedChange: setIsHotkeyEnabled,
                                disabled: !isConnected
                            }, void 0, false, {
                                fileName: "[project]/src/components/ArduinoControl.tsx",
                                lineNumber: 139,
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: isConnected ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                            children: "Status: Connected and running in background"
                        }, void 0, false, {
                            fileName: "[project]/src/components/ArduinoControl.tsx",
                            lineNumber: 161,
                            columnNumber: 13
...
_s(ArduinoControl, "22wSNSi4BXacuLc0EwaCvn6CfQs=");
_c = ArduinoControl;
var _c;
__turbopack_context__.k.register(_c, "ArduinoControl");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(module, globalThis.$RefreshHelpers$);
}
}}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/button.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$input$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/input.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ArduinoControl$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ArduinoControl.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ui$2f$alert$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/components/ui/alert.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
'use client';
...
function SettingsPage() {
    ...
    const [configName, setConfigName] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])('default');
    ...
    const handleSaveConfig = ()=>{
        ...
        localStorage.setItem('valorant-config', JSON.stringify(config));
        setShowSaveSuccess(true);
        setTimeout(()=>setShowSaveSuccess(false), 3000);
    };
    const handleLoadConfig = ()=>{
        const savedConfig = localStorage.getItem('valorant-config');
        if (savedConfig) {
    ...
    const handleResetConfig = ()=>{
        ...
        localStorage.removeItem('valorant-config');
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            ...
            children: [
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$ArduinoControl$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ArduinoControl"], {}, void 0, false, {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: "Valorant Arduino Control"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/settings/page.tsx",
                                        lineNumber: 116,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                        children: "A web-based GUI for controlling Arduino-based Valorant assistance"
                                    }, void 0, false, {
                                        fileName: "[project]/src/app/settings/page.tsx",
                                        lineNumber: 118,
                                        columnNumber: 15
...
_s(SettingsPage, "UsEkRBIhe1Rwe7+NJa9nP+TvPYE=");
_c = SettingsPage;
var _c;
...
//# sourceMappingURL=_ddc99240._.js.map